...
# Layers vorbereiten
layers = []  # Ensure layers is defined

# Auswahlmöglichkeiten für die Anzeige der Layer
layer_options = {
...
for option, details in layer_options.items():
    if st.checkbox(f'{option} beteiligt', True):
...
# Pydeck Deck für die Karte mit Layern
if layers:  # Only attempt to create the deck if layers are defined
...
heatmap_layer = pdk.Layer(
    ...
    intensity=1,
    threshold=0.05,
    color_range=[(63, 40, 102), (108, 57, 123), (142, 73, 133), (178, 88, 142), (216, 104, 149), (248, 120, 150), (252, 148, 139), (253, 174, 120), (254, 200, 100), (255, 227, 80)]
)

# Erstellen des zweiten Deck-Objekts für die Heatmap
heatmap = pdk.Deck(
    layers=[heatmap_layer],
    initial_view_state=view_state,
    map_style=map_style  # Use the same map style as chosen for the primary map
)
